...
set(gca,'FontName','Avenir','LineWidth',3,'FontSize',24)
xlabel('ratio of cluster sizes (large/small), n_r','FontSize',24,'FontName','Avenir')
ylabel('ratio of cell growth rates (small/large), \lambda_r','FontSize',24,'FontName','Avenir')
text(25,2.25,'coexistence','FontSize',24,'FontName','Avenir','Color',[1 1 1])
box off
text(5,3.4,'only small clusters','FontSize',24,'FontName','Avenir')
text(25,1.3,'only large clusters','FontSize',24,'FontName','Avenir')    
...
set(gca,'LineWidth',3,'FontSize',24, 'FontName','Avenir')
xlabel('frequency of large clusters','FontSize',24,'FontName','Avenir')
ylabel('selection coefficient','FontSize',24,'FontName','Avenir')
hold on
...
text(.4,1.85,'settling','FontSize',24,'FontName','Avenir','Color',settling)
text(.2,-2,'growth','FontSize',24,'FontName','Avenir','Color',growth)
text(.65,-.4,'combined','FontSize',24,'FontName','Avenir','Color',combined)
ylim([-4 2.5])
box off
